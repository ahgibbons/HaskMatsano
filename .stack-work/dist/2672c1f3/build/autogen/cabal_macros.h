...
/* package bitwise-0.1.1.1 */
#define VERSION_bitwise "0.1.1.1"
...
/* package bytestring-read-0.3.1 */
#define VERSION_bytestring_read "0.3.1"
#define MIN_VERSION_bytestring_read(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
...
/* tool pkg-config-0.20 */
#define TOOL_VERSION_pkg_config "0.20"
